...
data = data.replace(
  ...
  `id: 'emilia-blanca',
    ...
    materials: {
      backrest: 'Malla transpirable de curva en S',
    ...
    pros: [
      ...
      'Estructura resistente con materiales certificados (madera FSC)'
    ],
    cons: [
...
console.log('Emilia data updated');
